...
function addMainBadge(readme) {
  ...
  if(headlineLevel1Regex.test(newReadme)) {
    ...
    console.log('lvl 1 headline found', `^(?<!${escapeRegExp(infoDelimiters[0])}[\S\s]*)#[^#].*$`, JSON.stringify(headlineLevel1Regex.exec(newReadme), null , 2))
...
async function addAutogradingInfo(fullReadme, results, packageJson) {
  ...
  const readmeInfo = `# <img src="https://github.com/DCI-EdTech/autograding-setup/raw/main/assets/bot-large.svg" alt="" data-canonical-src="https://github.com/DCI-EdTech/autograding-setup/raw/main/assets/bot-large.svg" height="31" /> Results
